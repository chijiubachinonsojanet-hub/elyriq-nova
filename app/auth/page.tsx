      ...
      <div className="content-container">
        ...
        {mode === "choose" && (
          <div style={{ maxWidth: "680px", width: "100%", textAlign: "center" }}>
            ...
            <h1 style={{ fontSize: "clamp(24px, 4vw, 40px)", fontWeight: 800, marginBottom: "12px", letterSpacing: "-0.02em" }}>
            ...
            <div className="responsive-grid-2">
              <div
                ...
                style={{ border: "1.5px solid rgba(255,62,165,0.3)", borderRadius: "20px", padding: "32px 24px", cursor: "pointer", textAlign: "left", background: "rgba(255,62,165,0.03)" }}
              >
                <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "#FF3EA5", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "22px", marginBottom: "16px" }}>🏢</div>
                <h3 style={{ fontSize: "17px", fontWeight: 700, marginBottom: "8px" }}>I Need Cleaning Services</h3>
                <p style={{ color: "#6b7280", fontSize: "13.5px", lineHeight: 1.6 }}>For homes, businesses, institutions, and events.</p>
              </div>
              <div
                onClick={() => setMode("choose-cleaner-type")}
                style={{ border: "1.5px solid rgba(255,255,255,0.1)", borderRadius: "20px", padding: "32px 24px", cursor: "pointer", textAlign: "left", background: "rgba(255,255,255,0.02)" }}
              >
                <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "rgba(255,62,165,0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "22px", marginBottom: "16px" }}>🧹</div>
                <h3 style={{ fontSize: "17px", fontWeight: 700, marginBottom: "8px" }}>I Offer Cleaning Services</h3>
                <p style={{ color: "#6b7280", fontSize: "13.5px", lineHeight: 1.6 }}>For individual cleaners and cleaning companies.</p>
              </div>
            </div>
        ...
        {mode === "choose-client-type" && (
          <div style={{ maxWidth: "680px", width: "100%", textAlign: "center" }}>
            <h1 style={{ fontSize: "clamp(22px, 3.5vw, 36px)", fontWeight: 800, marginBottom: "12px", letterSpacing: "-0.02em" }}>
            ...
            <div className="responsive-grid-2">
              {[
                ...
                <div
                  ...
                  style={{ border: "1.5px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "24px", cursor: "pointer", textAlign: "left", background: "rgba(255,255,255,0.02)" }}
                >
            ...
            <div className="responsive-grid-2">
              {[
                ...
                <div
                  key={item.type}
                  onClick={() => { setUserType(item.type as UserType); setMode("signup"); }}
                  style={{ border: "1.5px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "28px 20px", cursor: "pointer", textAlign: "left", background: "rgba(255,255,255,0.02)" }}
                >
        ...
        {mode === "signup" && (
          <div style={{ maxWidth: "480px", width: "100%" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255,62,165,0.1)", border: "1px solid rgba(255,62,165,0.2)", borderRadius: "999px", padding: "6px 14px", marginBottom: "20px" }}>
              <span style={{ color: "#FF3EA5", fontSize: "12px", fontWeight: 600 }}>{getUserTypeLabel()}</span>
            </div>
            <h1 style={{ fontSize: "clamp(24px, 3.5vw, 32px)", fontWeight: 800, marginBottom: "8px", letterSpacing: "-0.02em" }}>
            ...
            <button style={{ width: "100%", padding: "14px", fontSize: "15px", fontWeight: 700, borderRadius: "10px", border: "none", background: "#FF3EA5", color: "#fff", cursor: "pointer", marginBottom: "20px", fontFamily: "Inter, Arial, sans-serif" }}>
        ...
        {mode === "login" && (
          <div style={{ maxWidth: "440px", width: "100%" }}>
            ...
            <p style={{ textAlign: "center", color: "#6b7280", fontSize: "13px" }}>
              ...
              <button onClick={() => setMode("choose")} style={{ background: "none", border: "none", color: "#FF3EA5", cursor: "pointer", fontSize: "13px", fontWeight: 600 }}>
                Sign up
              </button>
            </p>
          </div>
